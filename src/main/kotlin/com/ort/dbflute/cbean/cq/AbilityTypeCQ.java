...
import com.ort.dbflute.cbean.cq.bs.BsAbilityTypeCQ;

/**
 * The condition-query of ABILITY_TYPE.
 * <p>
 ...
 */
public class AbilityTypeCQ extends BsAbilityTypeCQ {
     ...
     */
    public AbilityTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
