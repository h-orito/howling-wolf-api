...
import com.ort.dbflute.cbean.cq.bs.BsFaceTypeCQ;

/**
 * The condition-query of FACE_TYPE.
 * <p>
 ...
 */
public class FaceTypeCQ extends BsFaceTypeCQ {
     ...
     */
    public FaceTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
