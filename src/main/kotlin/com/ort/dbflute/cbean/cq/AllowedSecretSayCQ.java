...
import com.ort.dbflute.cbean.cq.bs.BsAllowedSecretSayCQ;

/**
 * The condition-query of ALLOWED_SECRET_SAY.
 * <p>
 ...
 */
public class AllowedSecretSayCQ extends BsAllowedSecretSayCQ {
     ...
     */
    public AllowedSecretSayCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
