...
/**
 * The base condition-bean of player_introduce.
 * @author DBFlute(AutoGenerator)
 */
public class BsPlayerIntroduceCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected PlayerIntroduceCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsPlayerIntroduceCB() {
     ...
     * @return this. (NotNull)
     */
    public PlayerIntroduceCB acceptPK(Integer playerIntroduceId) {
        assertObjectNotNull("playerIntroduceId", playerIntroduceId);
        BsPlayerIntroduceCB cb = this;
        cb.query().setPlayerIntroduceId_Equal(playerIntroduceId);
        return (PlayerIntroduceCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public PlayerIntroduceCB acceptUniqueOf(Integer fromPlayerId, Integer toPlayerId) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_PlayerIntroduceId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_PlayerIntroduceId_Desc();
        return this;
    }
     ...
     */
    public PlayerIntroduceCQ query() {
        assertQueryPurpose(); // assert only when user-public query
        return doGetConditionQuery();
    }

    public PlayerIntroduceCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected PlayerIntroduceCQ doGetConditionQuery() {
    ...
    protected PlayerIntroduceCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected PlayerIntroduceCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        PlayerIntroduceCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected PlayerIntroduceCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new PlayerIntroduceCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<PlayerIntroduceCB> unionCBLambda) {
        final PlayerIntroduceCB cb = new PlayerIntroduceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PlayerIntroduceCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<PlayerIntroduceCB> unionCBLambda) {
        final PlayerIntroduceCB cb = new PlayerIntroduceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final PlayerIntroduceCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">playerIntroduceBhv</span>.selectEntity(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * }).alwaysPresent(<span style="color: #553000">playerIntroduce</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">playerIntroduce</span>.<span style="color: #CC4747">getPlayerByFromPlayerId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     ...
     *     <span style="color: #553000">cb</span>.query().set...
     * }).alwaysPresent(<span style="color: #553000">playerIntroduce</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">playerIntroduce</span>.<span style="color: #CC4747">getPlayerByToPlayerId()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<PlayerIntroduceCQ> {
        protected PlayerCB.HpSpecification _playerByFromPlayerId;
        protected PlayerCB.HpSpecification _playerByToPlayerId;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<PlayerIntroduceCQ> qyCall
         ...
         */
        public SpecifiedColumn columnPlayerIntroduceId() { return doColumn("PLAYER_INTRODUCE_ID"); }
        /**
        ...
        @Override
        protected String getTableDbName() { return "player_introduce"; }
        /**
         ...
         */
        public HpSDRFunction<PlayerIntroduceCB, PlayerIntroduceCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<PlayerIntroduceCB> sq, PlayerIntroduceCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public PlayerIntroduceCB dreamCruiseCB() {
        PlayerIntroduceCB cb = new PlayerIntroduceCB();
        cb.xsetupForDreamCruise((PlayerIntroduceCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<PlayerIntroduceCB> columnQuery(final SpecifyQuery<PlayerIntroduceCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected PlayerIntroduceCB xcreateColumnQueryCB() {
        PlayerIntroduceCB cb = new PlayerIntroduceCB();
        cb.xsetupForColumnQuery((PlayerIntroduceCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<PlayerIntroduceCB> orCBLambda) {
        xorSQ((PlayerIntroduceCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<PlayerIntroduceCB> andCBLambda) {
        xorSQAP((PlayerIntroduceCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final PlayerIntroduceCB cb;
        if (mainCB != null) {
            cb = (PlayerIntroduceCB)mainCB;
        } else {
            cb = new PlayerIntroduceCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return PlayerIntroduceCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return PlayerIntroduceCQ.class.getName(); }
