...
class VillageController(
    ...
    fun registerAutoGeneratedVillage(
        ...
        val village: Village = convertRegisterBodyToAutoGeneratedVillage(body, player)
    ...
    //                                                                        Assist Logic
    //                                                                        ============
    private fun convertRegisterBodyToAutoGeneratedVillage(body: AutoGeneratedVillageRegisterBody, player: Player): Village {
        return Village(
            id = 1, // dummy
            name = "dummy village name",
            creatorPlayerId = player.id,
            status = VillageStatus(CDef.VillageStatus.プロローグ),
            setting = convertRegisterBodyToAutoGeneratedVillageSettings(body),
    ...
    private fun convertRegisterBodyToAutoGeneratedVillageSettings(body: AutoGeneratedVillageRegisterBody): VillageSettings {
        val personNum = body.organization!!.length
        return VillageSettings(
            ...
            organizations = VillageOrganizations(mapOf(personNum to body.organization!!)),
            rules = VillageRules(
                openVote = false,
