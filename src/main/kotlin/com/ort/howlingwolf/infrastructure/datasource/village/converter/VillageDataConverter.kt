    ...
    private fun convertVillageSettingListToVillageSetting(
        ...
        return VillageSettings(
            ...
            organizations = VillageOrganizations(
                organization = detectItemText(
                    settingList,
                    CDef.VillageSettingItem.構成
                )?.let { convertOrganizeToOrganizationMap(it) }
            ),
            rules = VillageRules.invoke(
                ...
                forBeginner = detectItemText(settingList, CDef.VillageSettingItem.初心者村か)?.let { it == FLG_TRUE },
