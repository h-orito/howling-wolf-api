...
@SpringBootTest
@Transactional
class AbilityDataSourceTest : Wolf4busyTest() {
    ...
    fun test_updateAbility() {
        ...
        val villageAbility = VillageAbility(
            ...
            ability = com.ort.wolf4busy.domain.model.ability.Ability(CDef.AbilityType.襲撃)
        )
    ...
    fun test_updateDifference() {
        ...
        val after = before.copy(
            list = before.list + VillageAbility(
                ...
                myselfId = villagePlayerId2,
                targetId = villagePlayerId,
                ability = com.ort.wolf4busy.domain.model.ability.Ability(CDef.AbilityType.占い)
            )
        )
