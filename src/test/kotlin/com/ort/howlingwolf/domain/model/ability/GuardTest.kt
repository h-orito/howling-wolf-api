...
@SpringBootTest
class GuardTest : HowlingWolfTest() {
    ...
    fun test_getSelectableTargetList_未参加者() {
        ...
        // ## Act ##
        val selectableTargetList = Guard.getSelectableTargetList(village, participant)
    ...
    fun test_getSelectingTarget_未参加者() {
        ...
        // ## Act ##
        val target = Guard.getSelectingTarget(village, participant, villageAbilities)
    ...
    fun test_getSetMessage_対象あり() {
        ...
        // ## Act ##
        val message = Guard.getSetMessage(chara, targetChara)
    ...
    fun test_getDefaultAbilityList_進行中でない() {
        ...
        // ## Act ##
        val villageAbilityList = Guard.getDefaultAbilityList(village)
    ...
    fun test_getDefaultAbilityList_対象あり() {
        ...
        assertThat(villageAbilityList.find { it.myselfId == aliveHunter.id }).satisfies {
            ...
            assertThat(it?.ability?.code).isEqualTo(CDef.AbilityType.護衛.code())
        }
    ...
    fun test_process_生存している狩人がいない() {
        ...
        // ## Act ##
        val afterDayChange = Guard.process(dayChange, charas)
