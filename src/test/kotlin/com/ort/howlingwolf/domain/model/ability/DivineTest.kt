...
@SpringBootTest
class DivineTest : HowlingWolfTest() {
    ...
    fun test_getSelectableTargetList_未参加者() {
        ...
        // ## Act ##
        val selectableTargetList = Divine.getSelectableTargetList(village, participant)
    ...
    fun test_getSelectingTarget_未参加者() {
        ...
        // ## Act ##
        val target = Divine.getSelectingTarget(village, participant, villageAbilities)
    ...
    fun test_getSetMessage_対象あり() {
        ...
        // ## Act ##
        val message = Divine.getSetMessage(chara, targetChara)
    ...
    fun test_getDefaultAbilityList_進行中でない() {
        ...
        // ## Act ##
        val villageAbilityList = Divine.getDefaultAbilityList(village)
    ...
    fun test_getDefaultAbilityList_対象あり() {
        ...
        assertThat(villageAbilityList.find { it.myselfId == aliveSeer.id }).satisfies {
            ...
            assertThat(it?.ability?.code).isEqualTo(CDef.AbilityType.占い.code())
        }
    ...
    fun test_process_生存している占い師がいない() {
        ...
        // ## Act ##
        val afterDayChange = Divine.process(dayChange, charas)
