...
CREATE TABLE PLAYER_INTRODUCE
(
	PLAYER_INTRODUCE_ID INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'プレイヤー紹介ID',
	FROM_PLAYER_ID INT UNSIGNED NOT NULL COMMENT 'プレイヤーID',
	TO_PLAYER_ID INT UNSIGNED NOT NULL COMMENT '紹介対象プレイヤーID',
	REGISTER_DATETIME DATETIME NOT NULL COMMENT '登録日時',
	REGISTER_TRACE VARCHAR(64) NOT NULL COMMENT '登録トレース',
	UPDATE_DATETIME DATETIME NOT NULL COMMENT '更新日時',
	UPDATE_TRACE VARCHAR(64) NOT NULL COMMENT '更新トレース',
	PRIMARY KEY (PLAYER_INTRODUCE_ID),
	CONSTRAINT UQ_player_introduce UNIQUE (FROM_PLAYER_ID, TO_PLAYER_ID)
) COMMENT = 'プレイヤー紹介';
...
(
    ...
    CLIENT_TOKEN VARCHAR(64) COMMENT 'クライアントトークン',
    REGISTER_DATETIME DATETIME NOT NULL COMMENT '登録日時',
    REGISTER_TRACE VARCHAR(64) NOT NULL COMMENT '登録トレース',
    UPDATE_DATETIME DATETIME NOT NULL COMMENT '更新日時',
    UPDATE_TRACE VARCHAR(64) NOT NULL COMMENT '更新トレース',
...
ALTER TABLE PLAYER_INTRODUCE
	ADD CONSTRAINT FK_PLAYER_INTRODUCE_PLAYER FOREIGN KEY (FROM_PLAYER_ID)
	REFERENCES PLAYER (PLAYER_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE PLAYER_INTRODUCE
	ADD CONSTRAINT FK_PLAYER_INTRODUCE_TO_PLAYER FOREIGN KEY (TO_PLAYER_ID)
	REFERENCES PLAYER (PLAYER_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
